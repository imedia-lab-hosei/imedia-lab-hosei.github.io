...
export const memberSections: MemberSection[] = [
  ...
  },
  {
    ...
    layout: 'text-grid',
    members: [
      { nameKey: 'iwasaki_yota', name: 'Iwasaki Yota' },
      { nameKey: 'asano_shunsuke', name: 'Asano Shunsuke' },
      { nameKey: 'nakajima_sawaki', name: 'Nakajima Sawaki' },
      { nameKey: 'ito_tomoki', name: 'Ito Tomoki' },
      { nameKey: 'mikano_ryota', name: 'Mikano Ryota' },
      { nameKey: 'enomoto_machika', name: 'Enomoto Machika' },
      { nameKey: 'nonoo_gaku', name: 'Nonoo Gaku' },
      { nameKey: 'ajiki_ren', name: 'Ajiki Ren' },
      { nameKey: 'kashiyama_keisuke', name: 'Kashiyama Keisuke' },
      { nameKey: 'yagihashi_kaito', name: 'Yagihashi Kaito' },
    ],
  },
  {
    id: 'b3',
  ...
  },
  {
    ...
    layout: 'alumni-list',
    members: [
      { nameKey: 'miyamoto_mizuki', name: 'Miyamoto Mizuki', destinationKey: 'docomo' },
      { nameKey: 'iwama_kosuke', name: 'Iwama Kosuke' },
      { nameKey: 'fan_wei', name: 'Fan Wei' },
      ...
      { nameKey: 'tran_thi_thu_thuy', name: 'Tran Thi Thu Thuy', destinationKey: 'rakuten' },
      { nameKey: 'nguyen_tan_ho', name: 'Nguyen Tan Ho', destinationKey: 'ficha' },
      { nameKey: 'gu_qirui', name: 'Gu Qirui', destinationKey: 'thoughtworks' },
      { nameKey: 'trinh_man_hoang', name: 'Trinh Man Hoang', destinationKey: 'ficha' },
      {
        nameKey: 'minh_man_ho',
        name: 'Minh Man Ho',
        destinationKey: 'utah',
      ...
      { nameKey: 'pham_do_kim_chi', name: 'Pham Do Kim Chi', destinationKey: 'ando_hazama' },
      {
        nameKey: 'catherine_waithera',
        name: 'Catherine Waithera Wangari',
        destinationKey: 'kisii',
      },
      { nameKey: 'miyoshi_hayato', name: 'Miyoshi Hayato', destinationKey: 'veriserve' },
      { nameKey: 'otagiri_kengo', name: 'Otagiri Kengo', destinationKey: 'accenture' },
      { nameKey: 'kikuchi_syunshuke', name: 'Kikuchi Syunshuke', destinationKey: 'mitsubishi' },
      { nameKey: 'makino_hiroya', name: 'Makino Hiroya', destinationKey: 'ntt_data' },
      { nameKey: 'usukura_riki', name: 'Usukura Riki', destinationKey: 'scsk' },
      { nameKey: 'fujii_riku', name: 'Fujii Riku', destinationKey: 'toyota' },
