...
export const memberSections: MemberSection[] = [
  ...
  },
  {
    ...
    layout: 'text-grid',
    members: [
      { nameKey: 'suzuki_haruchika', name: 'Haruchika Suzuki' },
      { nameKey: 'ento_mai', name: 'Mai Ento' },
      { nameKey: 'osuga_akikage', name: 'Akikage Osuga' },
      { nameKey: 'huang_wenzhuo', name: 'Wenzhuo Huang' },
      { nameKey: 'shimada_mau', name: 'Mau Shimada' },
      { nameKey: 'tani_hinako', name: 'Hinako Tani' },
      { nameKey: 'teshigawara_eita', name: 'Eita Teshigawara' },
      { nameKey: 'miura_takuya', name: 'Takuya Miura' },
      { nameKey: 'miyazaki_kosei', name: 'Kosei Miyazaki' },
      { nameKey: 'yoshitake_miharu', name: 'Miharu Yoshitake' },
      { nameKey: 'liu_yuchen', name: 'LIU YUCHEN' },
    ],
  },
  {
    id: 'alumni',
