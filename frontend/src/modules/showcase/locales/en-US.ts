  ...
  aboutUs: {
    ...
    members: {
      ...
      names: {
        ...
        ding_jinhao: 'Jinhao Ding',
        wang_qi: 'Qi Wang',
        chen_shiyu: 'Shiyu Chen',
        wang_haixin: 'Haixin Wang (Mirai Sato)',
        kimishima_fuma: 'Fuma Kimishima',
        yuan_lingfan: 'Lingfan Yuan',
        miyamoto_mizuki: 'Mizuki Miyamoto',
        ...
        iwasaki_yota: 'Yota Iwasaki',
        asano_shunsuke: 'Shunsuke Asano',
        nakajima_sawaki: 'Sawaki Nakajima',
        ito_tomoki: 'Tomoki Ito',
        mikano_ryota: 'Ryota Mikano',
        enomoto_machika: 'Machika Enomoto',
        nonoo_gaku: 'Gaku Nonoo',
        ajiki_ren: 'Ren Ajiki',
        kashiyama_keisuke: 'Keisuke Kashiyama',
        yagihashi_kaito: 'Kaito Yagihashi',
        suzuki_haruchika: 'Haruchika Suzuki',
        ento_mai: 'Mai Ento',
        osuga_akikage: 'Akikage Osuga',
        huang_wenzhuo: 'Wenzhuo Huang',
        shimada_mau: 'Mau Shimada',
        tani_hinako: 'Hinako Tani',
        teshigawara_eita: 'Eita Teshigawara',
        miura_takuya: 'Takuya Miura',
        miyazaki_kosei: 'Kosei Miyazaki',
        yoshitake_miharu: 'Miharu Yoshitake',
        liu_yuchen: 'LIU YUCHEN',
        jianbin_zhou: 'Jianbin Zhou',
        tran_thi_thu_thuy: 'Thi Thu Thuy Tran',
        nguyen_tan_ho: 'Tan Ho Nguyen',
        gu_qirui: 'Qirui Gu',
        trinh_man_hoang: 'Man Hoang Trinh',
        minh_man_ho: 'Minh Man Ho',
        jirayu_peetakul: 'Jirayu Peetakul',
        pham_do_kim_chi: 'Do Kim Chi Pham',
        catherine_waithera: 'Catherine Waithera Wangari',
        miyoshi_hayato: 'Hayato Miyoshi',
        otagiri_kengo: 'Kengo Otagiri',
        kikuchi_syunshuke: 'Syunshuke Kikuchi',
        makino_hiroya: 'Hiroya Makino',
        usukura_riki: 'Riki Usukura',
        fujii_riku: 'Riku Fujii',
        hayama_hibiki: 'Hibiki Hayama',
        zhiqiang_zhang: 'Zhiqiang Zhang',
        fu_chen: 'Chen Fu',
        jiayao_xu: 'Jiayao Xu',
        yang_jian: 'Jian Yang',
        hayashi_shinkou: 'Shinkou Hayashi',
        haga_shinkou: 'Shinkou Haga',
        nakano_kyoka: 'Kyoka Nakano',
        xin_cheng: 'Cheng Xin',
      },
      destinations: {
        dji: 'DJI',
