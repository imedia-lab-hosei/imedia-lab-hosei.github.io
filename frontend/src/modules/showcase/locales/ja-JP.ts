export default {
  ...
  aboutUs: {
    ...
    members: {
      ...
      names: {
        ...
        suzuki_haruchika: '鈴木 治親',
        ento_mai: '遠藤 舞',
        osuga_akikage: '大須賀 秋景',
        huang_wenzhuo: '黄 文卓',
        shimada_mau: '島田 麻羽',
        tani_hinako: '谷 陽南子',
        teshigawara_eita: '勅使川原 瑛太',
        miura_takuya: '三浦 拓弥',
        miyazaki_kosei: '宮﨑 皓生',
        yoshitake_miharu: '吉武 美陽',
        liu_yuchen: 'ＬＩＵ ＹＵＣＨＥＮ',
  ...
  home: {
    ...
    news: {
      title: 'ニュース',
      more: '詳細を見る',
      item0: '2026年度「若手研究者共同研究プロジェクト」に研究プロジェクトが採択されました',
