<template>
  <div class="flex w-full items-center justify-center gap-4 py-8">
    ...
    <UButton label="Open Modal (Controlled)" @click="open = true" />

    <!-- Method 2: Uncontrolled Mode -->
    <AnimatedModal v-slot="{ openModal, closeModal }" v-model:open="open">
      <UButton label="Open Modal (Uncontrolled)" @click="openModal" />
